...
contract Staking {
    ...
    function stake() public payable {
        require(msg.value >= min, "Minimum 0.005 ether!");
        require(msg.sender.balance >= msg.value, "Not enough ethers on the balance!");
        require(stakedBalances[msg.sender] == 0, "Stake already exists.");
    ...
    function withdraw() public {
        require(stakedBalances[msg.sender] >= min, "You dont have a stake balance");
